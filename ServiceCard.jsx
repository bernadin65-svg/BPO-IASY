...
const ServiceCard = ({service, index}) => {
    ...
    return (
        ...
        className='relative over-flow-hidden maw-w-lg m-2 sm:m-4 
        rounded-xl border border-gray-200 dark:border-gray-700 shadow-gray-100 
        dark:shadow-white/10' onMouseEnter={()=>setVisible(true)} onMouseLeave={()=>setVisible(false)} 
        ref={divRef} onMouseMove={handleMouseMove}>

<div className={`pointer-events-none blur-2x1 rounded-full 
...
<div className='flex items-center gap-10 p-8
 hover:p-7.5 hover:m-0.5 transition-all rounded-[10px] bg-white
  dark:white dark:bg-gray-900  z-10 relative'>
    <div className='bg-gray-100 dark:bg-gray-700 rounded-full'>
        <img src={service.icon} alt="" className='max-w-24 bg-white 
        dark:gray-900 rounded-full m-2' />
    </div>
